...
describe('node-read-yaml-files', () => {
  ...
  it('should return an array', () => {
    return readFiles('./yaml-samples/simple').then((result) => {
  ...
  it('should read multi-document with option', () => {
    return readFiles('./yaml-samples/multi-docs', { multi: true }).then(
      (result) => {
        expect(result).to.be.an('array').to.have.lengthOf(2);
        expect(result).to.be.eql([
          [
  ...
  it('should return a 2-depth array', () => {
    return readFiles('./yaml-samples/array').then((result) => {
      expect(result).to.be.an('array').to.have.lengthOf(2);
      expect(result).to.be.eql([
        [
          {
  ...
  it('should return a 1-depth array with flatten option', () => {
    return readFiles('./yaml-samples/array', { flatten: true }).then(
      (result) => {
        expect(result).to.be.an('array').to.have.lengthOf(4);
        expect(result).to.be.eql([
          {
  ...
  it('should return a 2-depth array with flatten option', () => {
    return readFiles('./yaml-samples/array-2-depth', { flatten: true }).then(
      (result) => {
        expect(result).to.be.an('array').to.have.lengthOf(4);
        expect(result).to.be.eql([
          [{ a1: 1 }, { a2: 2 }],
  ...
  it('should return a 3-depth array', () => {
    return readFiles('./yaml-samples/array-2-depth').then((result) => {
      expect(result).to.be.an('array').to.have.lengthOf(2);
      expect(result).to.be.eql([
        [
          [{ a1: 1 }, { a2: 2 }],
  ...
  it('should return an array with file path', () => {
    return readFiles('./yaml-samples/simple', { withFile: true }).then(
      (result) => {
        expect(result).to.be.an('array').to.have.lengthOf(2);
        expect(result).to.be.eql([
